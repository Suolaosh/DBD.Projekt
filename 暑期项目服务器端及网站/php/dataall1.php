...
$sql = "SELECT temp.id,temp.temp,hum.hum,intens.intens,intens.while,intens.deviceid FROM temp,hum,intens WHERE temp.id=hum.id and hum.id = intens.id ORDER BY temp.time DESC LIMIT 1";
